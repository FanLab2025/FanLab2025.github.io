...
(function () {
  ...
  function renderAbout(about, container) {
    ...
    container.innerHTML =
      ...
      '<img class="logo-mark logo-mark--about" src="assets/images/fan-lab-lockup.svg" alt="FAN Lab" />' +
      "</div>" +
      paras +
  ...
  function renderPI(profile, container) {
    ...
    container.innerHTML =
      ...
      "</div>" +
      "<div>" +
      '<img class="logo-mark logo-mark--pi" src="assets/images/fan-lab-lockup.svg" alt="FAN Lab" />' +
